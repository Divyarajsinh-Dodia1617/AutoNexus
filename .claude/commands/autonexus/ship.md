---
name: autonexus:ship
description: Universal shipping workflow — ship code, content, marketing, sales, research, or anything through structured 8-phase workflow + Obsidian knowledge backbone
...
2. Read the ship workflow: `.claude/skills/autonexus/references/ship-workflow.md`
3. If ship type is unclear — use `AskUserQuestion` with batched questions per ship-workflow.md
4. Execute the 8-phase ship workflow (Identify → Inventory → Checklist → Prepare → Dry-run → Ship → Verify → Log)
